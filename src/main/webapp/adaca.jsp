    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form action="adaca" id="acaPageForm">
                            <%
                                List<AcademicsEntity> list = (List<AcademicsEntity>) request.getAttribute("acalist");
                            ...
                            <table id="sample-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    <td>
                                        <a href="<%=path%>/academics/<%=n.getId()%>"><%=n.getTitle()%>
                                        </a>
                                    </td>
                                    <td><%=n.getDate()%></td>
                                    <td>
...
<!-- dialog -->
<%@ include file="WEB-INF/dialog-aca.jsp"%>
<!-- dialog-over -->
