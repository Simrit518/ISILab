...
<div class="container">
    <div class="row" style="margin-top: 30px">
        ...
        <!-- 新闻列表表单 -->
        <form action="result" id="resultPageFrom">
            <%
                List<ResultEntity> list = (List<ResultEntity>) request.getAttribute("resultlist");
            ...
            <div class="list-group">
                ...
                <a href="<%=path%>/result/<%=n.getId()%>" class="list-group-item"><%=n.getTitle()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=n.getDate()%></a>
                <%}%>
            </div>
...
<script src="js/reslist.js "></script>
