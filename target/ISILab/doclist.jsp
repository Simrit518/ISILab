...
<div class="container">
    <div class="row" style="margin-top: 30px">
        ...
        <!-- 新闻列表表单 -->
        <form action="document" id="documentPageFrom">
            <%
                List<DocumentEntity> list = (List<DocumentEntity>) request.getAttribute("documentlist");
            ...
            <div class="list-group">
                ...
                <a href="<%=path%>/document/<%=n.getId()%>" class="list-group-item"><%=n.getTitle()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=n.getDate()%></a>
                <%}%>
            </div>
